    ...
    <div className="max-w-4xl mx-auto px-6 relative z-10">
      <Reveal>
        <div className="text-center mb-8">
          ...
          <p className="inline-block text-amber-500 font-black uppercase tracking-[0.3em] text-xs md:text-base mt-4">
            LOTE ESPECIAL POR TEMPO LIMITADO
          </p>
        </div>
        <div className="glass p-8 md:p-16 rounded-[2.5rem] md:rounded-[3.5rem] border-amber-500/30 text-center bg-zinc-950/60 relative overflow-hidden shadow-[0_0_100px_rgba(245,158,11,0.15)]">
          <div className="absolute top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-emerald-500 text-black text-[9px] font-black uppercase tracking-[0.2em] rounded-full shadow-lg">
            INSCRIÇÕES ABERTAS | LOTE 1
          </div>
